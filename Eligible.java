...
public class Eligible {
    ...
    for(int i = 0; i < k; i++){
       String e = StdIn.readLine();
        comp.add(e);
        MapMakerLikeNami.incursio(courses, e, comp);
    }

     Set<HashMap.Entry<String, ArrayList<String>>> a = courses.entrySet();

     ArrayList<String> eli = MapMakerLikeNami.eligibleAssist(a, comp);
